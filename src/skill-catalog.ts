// Skill display catalog: product/UI strings for all quiz modes.
// Separated from music-data.ts, which should only contain music theory data.
//
// Contains: skill names, descriptions, before/after contrast text, and
// track definitions for the home screen.

import { displayNote } from './music-data.ts';

// ---------------------------------------------------------------------------
// Skill descriptions — shown on home screen cards and practice tab headers.
// ---------------------------------------------------------------------------
...
export const SKILL_ABOUT_DESCRIPTIONS: Record<string, string> = {
  fretboard:
...
// ---------------------------------------------------------------------------
// Centralized display names for all skills.
// ---------------------------------------------------------------------------
...
export const SKILL_BEFORE_AFTER: Record<
  string,
