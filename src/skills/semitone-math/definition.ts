...
export const SEMITONE_MATH_DEF: SkillDefinition<Question> = {
  id: 'semitoneMath',
  name: 'Semitone Math',
  namespace: 'semitoneMath',
  description: SKILL_DESCRIPTIONS.semitoneMath,
  aboutDescription: SKILL_ABOUT_DESCRIPTIONS.semitoneMath,
  beforeAfter: SKILL_BEFORE_AFTER.semitoneMath,
  itemNoun: 'items',
  ...
  scope: {
    ...
    formatLabel: (levels) => {
      if (levels.size === DISTANCE_LEVELS.length) return 'all distances';
