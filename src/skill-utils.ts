// Shared utilities for skill logic: ID parsing, ID building, stats helpers.
// Pure functions — no DOM, no hooks, no side effects.
// Used by per-skill logic.ts files to avoid duplicating mechanical patterns.
...
/**
 * Build item IDs for a bidirectional skill from a list of keys.
...
/**
 * Build item IDs for a math skill from notes × values.
...
/**
 * Build stats table rows for a bidirectional skill.
