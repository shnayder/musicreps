...
// ---------------------------------------------------------------------------
// Practice Redesign tab — new skill screen components
// ---------------------------------------------------------------------------

// Mock progress colors for skill header
...
function PracticeRedesignTab(
  { sel: _sel, groupSel: _groupSel }: {
    sel: StatsSelector;
    groupSel: GroupSel;
  },
) {
  ...
  return (
    <div>
      ...
      {activeTab === 'practice-redesign' && (
        <PracticeRedesignTab sel={sel} groupSel={groupSel} />
      )}
