...
describe('buildRecommendationText', () => {
  ...
  it('builds review text', () => {
    const result: RecommendationResult = {
      ...
      expandNewCount: 0,
      levelRecs: [
        { levelId: '0', type: 'review' },
        { levelId: '1', type: 'review' },
      ],
    };
  ...
  it('builds practice text', () => {
    const result: RecommendationResult = {
      ...
      expandIndex: null,
      expandNewCount: 0,
      levelRecs: [{ levelId: '0', type: 'practice' }],
    };
    const text = buildRecommendationText(result, label);
  ...
  it('builds expand text', () => {
    const result: RecommendationResult = {
      ...
      expandIndex: '2',
      expandNewCount: 8,
      levelRecs: [{ levelId: '2', type: 'expand' }],
    };
    const text = buildRecommendationText(result, label);
  ...
  it('builds automate text', () => {
    const result: RecommendationResult = {
      ...
      expandNewCount: 0,
      levelRecs: [
        { levelId: '0', type: 'automate' },
        { levelId: '1', type: 'automate' },
      ],
    };
    const text = buildRecommendationText(result, label);
  ...
  it('combines review + practice + expand + extra parts', () => {
    const result: RecommendationResult = {
      ...
      levelRecs: [
        { levelId: '0', type: 'review' },
        { levelId: '1', type: 'practice' },
        { levelId: '2', type: 'expand' },
      ],
    };
  ...
  it('expand text has no item count suffix', () => {
    const result: RecommendationResult = {
      ...
      expandIndex: '0',
      expandNewCount: 1,
      levelRecs: [{ levelId: '0', type: 'expand' }],
    };
    const text = buildRecommendationText(result, label);
