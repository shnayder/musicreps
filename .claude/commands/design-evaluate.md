...
| --------------------- | ---------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ |
| Type hierarchy        | `../musicreps-docs/guides/design/visual-design.md` § Type Hierarchy                                                    | Text sizing, weight, color issues                |
| Button taxonomy       | `../musicreps-docs/guides/design/visual-design.md` § Button Variant Taxonomy                                           | Button/action styling issues                     |
| Token compliance      | `../musicreps-docs/guides/design/visual-design.md` + `.claude/commands/review-checklist.md` § Design system compliance | Any hardcoded CSS values                         |
| Layout & IA           | `../musicreps-docs/guides/design/layout-and-ia.md`                                                                     | Content order, grouping, labeling, screen states |
| Elevation             | `../musicreps-docs/guides/design/visual-design.md` § Elevation                                                         | Shadow/depth mismatches                          |
| Interaction states    | `../musicreps-docs/guides/design/visual-design.md` § Focus, hover, active                                              | Missing interactive feedback                     |
| Structural components | `../musicreps-docs/guides/design/visual-design.md` § Structural Components                                             | Should be using Text/ActionButton                |
| Spacing/rhythm        | `../musicreps-docs/guides/design/visual-design.md` § Spacing Scale                                                     | Spacing inconsistencies, density issues          |
| Design principles     | `../musicreps-docs/guides/design-principles.md`                                                                        | High-level tone, feel, product fit               |
